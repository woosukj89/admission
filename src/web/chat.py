...
■ 특정 대학 입결 조회 (학생 성적 없음) → browse_university_results 사용
  예시: "부산대 교과전형 학과 컷 알려줘", "동국대 종합전형 내신컷 낮은 순서",
        "명지대 교과 내신 순서대로 알려줘", "○○대 입결 보여줘"
  → browse_university_results(university="○○대", process_type="교과" 또는 "종합" 등)
  → "낮은 순서"(합격 쉬운 순) = sort="desc", "높은 순서"(합격 어려운 순) = sort="asc"
  ★ 학생이 자신의 성적을 알려주지 않고 특정 대학의 전형·학과 컷만 물어볼 때 이 도구를 사용하세요.
