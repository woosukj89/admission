"""
Fix 경북대학교 admission_result labeling error.
...
The grade_type='수능등급' is retained — 경북대 reports admitted students'
...
def run(dry_run: bool = False):
    ...
    print(f"Found {len(rows)} 경북대 records to fix (admission_type '정시' → '수시')")
    if dry_run:
